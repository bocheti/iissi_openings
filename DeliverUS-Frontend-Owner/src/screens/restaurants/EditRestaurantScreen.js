...
export default function EditRestaurantScreen ({ navigation, route }) {
  ...
  const [initialRestaurantValues, setInitialRestaurantValues] = useState({ name: null, description: null, address: null, postalCode: null, url: null, shippingCosts: null, email: null, phone: null, restaurantCategoryId: null, status: null, logo: null, heroImage: null })
  const validationSchema = yup.object().shape({
    ...
    status: yup
      .string()
      .nullable()
      .oneOf(['offline', 'online', 'closed', 'temporarily closed'], 'Invalid status; must be offline, online, closed or temporarily closed')
  })
